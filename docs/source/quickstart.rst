...
The following is a short description of how to connect to a HP 16600 / 16700 logic analyzer, set-up some basic configuration and collect data
...
Once the logic analyzer has been configured we can start it and poll it's status
